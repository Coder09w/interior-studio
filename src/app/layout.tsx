...
export const metadata: Metadata = {
  ...
  description: "Interactive 3D interior design previewer with furniture library, material system, and real-time controls.",
  keywords: ["interior design", "3D", "Three.js", "room planner", "furniture"],
  icons: {
