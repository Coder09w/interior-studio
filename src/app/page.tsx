...
function HeroSection() {
  return (
    ...
    >
      ...
      <div className="absolute top-20 right-1/4 w-96 h-96 rounded-full opacity-20 blur-3xl" style={{ background: 'linear-gradient(135deg, #C17F4E, #D4A76A)' }} />
      <div className="absolute bottom-20 left-1/4 w-72 h-72 rounded-full opacity-10 blur-3xl" style={{ background: 'linear-gradient(135deg, #8B7355, #C17F4E)' }} />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            {/* Floating card - left */}
            <div
              className="absolute -left-4 sm:-left-8 top-1/4 px-4 py-3 rounded-xl shadow-xl border animate-[fadeInUp_0.6s_ease_0.3s_both]"
              style={{
                background: '#FFFFFF',
                borderColor: '#E2DDD4',
              }}
            ...
            {/* Floating card - right */}
            <div
              className="absolute -right-2 sm:-right-6 bottom-1/4 px-4 py-3 rounded-xl shadow-xl border animate-[fadeInUp_0.6s_ease_0.5s_both]"
              style={{
                background: '#FFFFFF',
                borderColor: '#E2DDD4',
              }}
...
function StatsSection() {
  const stats = [
    { value: '30+', label: 'Furniture Items' },
    { value: '5', label: 'Room Types' },
    { value: '4', label: 'Lighting Moods' },
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map(({ value, label }) => (
            <div key={label} className="text-center">
              <p className="text-3xl sm:text-4xl font-bold" style={{ fontFamily: "'Outfit', sans-serif", color: '#C17F4E' }}>{value}</p>
