...
We use PostHog, a privacy-first analytics platform, to gather aggregated usage statistics and understand how users interact with our website. PostHog helps us track metrics such as page views, session duration, navigation paths, and feature adoption rates. This includes anonymous behavior tracking to understand user journeys — from homepage visits and signups, to room creation, furniture placement, and design saves. The insights derived from PostHog analytics help us optimize the user interface, improve performance, identify drop-off points where users leave, and measure product success. We use this data solely for product improvement — not for advertising, retargeting, or selling to third parties. You may choose to opt out of analytics cookies through the cookie consent banner on our platform or through your browser settings. If you opt out, PostHog will use memory-only persistence and will not store any tracking cookies on your device. Disabling analytics cookies will not affect the core functionality of the 3D editor or your ability to save and manage designs.`,
  },
  {
...
For analytics, we use PostHog (posthog.com), a privacy-first product analytics platform. PostHog processes usage data on our behalf to help us understand how users interact with Instod. When you are identified (e.g., logged in), PostHog may associate your account ID, email, and plan type with your usage events for the purpose of understanding user journeys and measuring feature adoption. PostHog does not use your data for its own purposes, and we have configured PostHog to disable session recording. PostHog's data processing is governed by their Data Processing Agreement (DPA), and data is hosted on secure infrastructure with encryption in transit and at rest. You can learn more about PostHog's privacy practices at posthog.com/privacy.
